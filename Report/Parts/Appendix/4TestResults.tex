...
\end{longtable}
\end{centering}
\subsection{Automated Graphical User Interface tests}
...
\paragraph{Test 4} - User, logout as user (GuiTest04UserLogout). \\
...
\paragraph{Test 10} - User, view current rentals (GuiTest10UserRentAndViewRentals). \\
