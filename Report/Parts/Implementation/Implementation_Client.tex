...
\paragraph{Bad input to server} If the server returns false (meaning bad input), in all cases, except at login, we should tell the user of the client that an authentication error has occured.
\paragraph{}